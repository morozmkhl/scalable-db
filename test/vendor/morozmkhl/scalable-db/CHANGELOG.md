...
- Removed `version` field from `composer.json` so Packagist accepts git tags (v1.1.1 was ignored due to mismatch with `"version": "1.1.0"`).
...
[1.1.2]: https://github.com/morozmkhl/scalable-db/compare/v1.1.1...v1.1.2
